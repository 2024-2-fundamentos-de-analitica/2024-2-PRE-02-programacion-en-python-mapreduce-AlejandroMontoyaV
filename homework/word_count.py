...
def line_preprocessing(sequence):
    ...
    return sequence
# se lleva todo a minusculas y se quitan saltos de linea \n
# se quitan puntos y comas
...
def mapper(sequence):
    ...
    result = []
    for key, value in sequence:
        for word in value.split(): # se divide cada linea en palabras
